 ...
 * parameter is the task identifier defined in deployment.h (ping_pinger_k) 
 * the second is the period defined in the AADL model. Third is the task 
 * priority ( 2), fourth is the stack size ( 0 bytes) and last is the 
 * subprogram executed by the task
 */
  __po_hi_create_periodic_task (ping_pinger_k, &(period), 2, 0, 0, pinger_job);
 ...
 */
  __po_hi_create_sporadic_task (ping_ping_me_k, &(period), 1, 0, 0, ping_me_job);
