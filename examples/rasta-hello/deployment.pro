...
isSubcomponent('deploymentview::DV','Node1','others','IV_Function1','SYSTEM','interfaceview::IV::Function1.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_Function1','Taste::FunctionName','"Function1"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_Function1','Taste::APLC_Binding','(reference (leon_partition))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','leon_partition','Taste::coordinates','"128938 66357 146173 78472"','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','leon_rtems','Taste::coordinates','"126784 62896 148327 80203"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"124091 57951 151020 82675"','').
