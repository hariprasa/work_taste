...
isConnection('BUS ACCESS','deploymentview::DV','deploymentview','others','Connection1','ip_i','->','Node1.generic_sockets_ip_pohic_ip_i','NIL','').
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Connection1','Taste::coordinates','"196880 92952 196880 115575 185457 115575"','').
...
isProperty('NIL','APPLIES TO','deploymentview::DV::Node1','generic_sockets_ip_pohic','NIL','link','Taste::Interface_Coordinates','"185457 115575"','').
...
isProperty('NIL','=>','deploymentview::DV::Node1','generic_sockets_ip_pohic','NIL','link','Taste::coordinates','"196880 92952"','').
...
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','generic_sockets_ip_pohic','Actual_Processor_Binding','(reference (leon_rtems))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','generic_sockets_ip_pohic','Taste::coordinates','"186353 78170 211439 92952"','').
...
isProperty('NIL','=>','deploymentview::DV::Node1','generic_sockets_ip_pohic','NIL','NIL','Deployment::Configuration','"{devname ""gr_eth1"", address ""192.168.0.81"", gateway ""192.168.0.1"", netmask ""255.255.0.0"", version ipv4, port 5118 }"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Connection2','Taste::coordinates','"101016 92505 101016 114679 111319 114679"','').
...
isProperty('NIL','=>','deploymentview::DV::Node2','generic_sockets_ip_pohic','NIL','link','Taste::coordinates','"101016 92505"','').
...
isProperty('NIL','=>','deploymentview::DV','Node2','others','generic_sockets_ip_pohic','Taste::coordinates','"90489 77722 115127 92505"','').
...
isProperty('NIL','=>','deploymentview::DV::Node2','generic_sockets_ip_pohic','NIL','NIL','Deployment::Configuration','"{devname ""ens3"", address ""127.0.0.1"", port 5115 }"','').
