...
cd "$SKELS" && rm -f producer.zip && zip producer producer/* && cd $OLDPWD

cd "$SKELS" && rm -f consumer.zip && zip consumer consumer/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subC producer:"$SKELS"/producer.zip \
	--subC consumer:"$SKELS"/consumer.zip \
